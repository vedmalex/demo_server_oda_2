...
export default class SocialNetwork
  ...
  public async addToCreatedBy(args: { socialNetwork?: string; user?: string }) {
  ...
  public async removeFromCreatedBy(args: {
    ...
    await this.findOneByIdAndUpdate(args.socialNetwork, { createdBy: null });
  }

  public async addToUpdateBy(args: { socialNetwork?: string; user?: string }) {
  ...
  public async removeFromUpdateBy(args: {
    ...
    await this.findOneByIdAndUpdate(args.socialNetwork, { updateBy: null });
  }
