  ...
  resolver: {
    ...
    createdBy: async (
      ...
      if (course && course.createdBy) {
        result = await context.connectors.User.findOneById(course.createdBy);
      }
    ...
    updateBy: async (
      ...
      let course = await context.connectors.Course.findOneById(id);
      //BelongsTo
      if (course && course.updateBy) {
        result = await context.connectors.User.findOneById(course.updateBy);
      }
