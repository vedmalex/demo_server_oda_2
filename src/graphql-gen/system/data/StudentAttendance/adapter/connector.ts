...
export default class StudentAttendance
  ...
  public async create(
    ...
    if (result) {
      ...
      const err = `connector for 'StudentAttendance': can't create item due to some issue`;
      logger.error(err);
      throw new Error(err);
    }
  }
  ...
  public async findOneByIdAndUpdate(
    ...
    if (result) {
      ...
      const err = `connector for 'StudentAttendance': can't update item due to some issue`;
      logger.error(err);
      throw new Error(err);
    }
    return this.ensureId(result.toJSON ? result.toJSON() : result);
  ...
  public async findOneByIdAndRemove(id: string) {
    ...
    if (result) {
      ...
      const err = `connector for 'StudentAttendance': can't remove item due to some issue`;
      logger.error(err);
      throw new Error(err);
    }
    return this.ensureId(result.toJSON ? result.toJSON() : result);
  ...
  public async addToMeetingLink(args: {
    ...
    if (opposite) {
      ...
      const err = `connector for 'StudentAttendance': can't addToMeetingLink opposite not found`;
      logger.error(err);
      throw new Error(err);
    }
  }
  ...
  public async addToStudentLink(args: {
    ...
    if (opposite) {
      ...
      const err = `connector for 'StudentAttendance': can't addToStudentLink opposite not found`;
      logger.error(err);
      throw new Error(err);
    }
  }
